...
public class TestUriMatcher extends AndroidTestCase {
    ...
    public void testUriMatcher() {
        ...
        assertEquals("Error: The WEATHER WITH LOCATION AND DATE URI was matched incorrectly." + TEST_WEATHER_WITH_LOCATION_AND_DATE_DIR,
                testMatcher.match(TEST_WEATHER_WITH_LOCATION_AND_DATE_DIR), WeatherProvider.WEATHER_WITH_LOCATION_AND_DATE);
        assertEquals("Error: The LOCATION URI was matched incorrectly." + TEST_LOCATION_DIR,
