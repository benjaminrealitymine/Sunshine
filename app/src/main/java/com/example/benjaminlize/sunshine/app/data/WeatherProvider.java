...
public class WeatherProvider extends ContentProvider {
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match){
            case WEATHER: {
                long _id = db.delete(WeatherContract.WeatherEntry.TABLE_NAME,selection,selectionArgs);
                if (_id > 0) {
                    returnedId = (int)_id;
                }
                break;
                ...
                case LOCATION: {
                long _id = db.delete(WeatherContract.LocationEntry.TABLE_NAME,selection,selectionArgs);
                    if (_id > 0) {
                        returnedId = (int)_id;
                    }
                break;
    ...
    public int update(
        ...
        switch (match){
            case WEATHER: {
                long _id = db.update(WeatherContract.WeatherEntry.TABLE_NAME,values,selection,selectionArgs);
                if (_id > 0) {
                    returnedId = (int)_id;
                }
                break;
            ...
            case LOCATION: {
                long _id = db.update(WeatherContract.LocationEntry.TABLE_NAME, values, selection, selectionArgs);
                if (_id > 0) {
                    returnedId = (int)_id;
                }
                break;
